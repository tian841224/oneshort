...
> 本檔只定義 OneShort 的**專案特化**：七層架構如何映射到本 repo、專案記憶存哪、與既有規則的串接。設計取捨見 [ADR-0012](../../docs/decisions/0012-self-learning-loop.md)。
...
- **決策**：[ADR-0012](../../docs/decisions/0012-self-learning-loop.md) 記錄本迴圈的架構、被拒方案與全域／專案分層取捨。
